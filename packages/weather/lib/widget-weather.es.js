...
import { getWeatherByRegion } from "@zly/data-store";
var common = "";
class JSBI extends Array {
  ...
  static toNumber(i) {
    ...
    const t = i.__digit(_ - 1), e = JSBI.__clz30(t), n2 = 30 * _ - e;
    if (1024 < n2)
      return i.sign ? -Infinity : 1 / 0;
    let g2 = n2 - 1, o = t, s = _ - 1;
    const l = e + 3;
    let r = l === 32 ? 0 : o << l;
    r >>>= 12;
    const a = l - 12;
    ...
    if ((h === 1 || h === 0 && (1 & u) == 1) && (u = u + 1 >>> 0, u === 0 && (r++, r >>> 20 != 0 && (r = 0, g2++, 1023 < g2))))
      return i.sign ? -Infinity : 1 / 0;
    const m2 = i.sign ? -2147483648 : 0;
    return g2 = g2 + 1023 << 20, JSBI.__kBitConversionInts[1] = m2 | g2 | r, JSBI.__kBitConversionInts[0] = u, JSBI.__kBitConversionDouble[0];
  }
  static unaryMinus(i) {
    if (i.length === 0)
      return i;
  ...
  static exponentiate(i, _) {
    ...
    if (i.length === 1 && i.__digit(0) === 2) {
      const _2 = 1 + (0 | t / 30), e2 = i.sign && (1 & t) != 0, n3 = new JSBI(_2, e2);
    ...
    for ((1 & t) != 0 && (e = i), t >>= 1; t !== 0; t >>= 1)
      n2 = JSBI.multiply(n2, n2), (1 & t) != 0 && (e === null ? e = n2 : e = JSBI.multiply(e, n2));
    return e;
  }
  static multiply(_, t) {
    if (_.length === 0)
    ...
    for (let n2 = 0; n2 < _.length; n2++)
      JSBI.__multiplyAccumulate(t, _.__digit(n2), e, n2);
    return e.__trim();
  }
  static divide(i, _) {
    if (_.length === 0)
    ...
    if (_.length === 1 && 32767 >= e) {
      ...
      n2 = JSBI.__absoluteDivSmall(i, e, null);
    } else
      n2 = JSBI.__absoluteDivLarge(i, _, true, false);
    return n2.sign = t, n2.__trim();
  }
  ...
  static bitwiseAnd(i, _) {
    ...
    if (i.sign && _.sign) {
      ...
      let n2 = JSBI.__absoluteSubOne(i, e);
  ...
  static bitwiseXor(i, _) {
    ...
    if (i.sign && _.sign) {
      const e2 = t(i.length, _.length), n3 = JSBI.__absoluteSubOne(i, e2), g2 = JSBI.__absoluteSubOne(_);
  ...
  static bitwiseOr(i, _) {
    ...
    if (i.sign && _.sign) {
      ...
      return t2 = JSBI.__absoluteAnd(t2, n3, t2), JSBI.__absoluteAddOne(t2, true, t2).__trim();
    }
    i.sign && ([i, _] = [_, i]);
    let n2 = JSBI.__absoluteSubOne(_, e);
  ...
  static asIntN(_, t) {
    ...
    if (t.length < e)
      return t;
    const g2 = t.__unsignedDigit(e - 1), o = 1 << (_ - 1) % 30;
    if (t.length === e && g2 < o)
      return t;
    if (!((g2 & o) === o))
    ...
    if ((g2 & o - 1) == 0) {
      ...
      return t.length === e && g2 === o ? t : JSBI.__truncateToNBits(_, t);
    }
    return JSBI.__truncateAndSubFromPowerOfTwo(_, t, false);
  }
  static asUintN(i, _) {
  ...
  static __fromDouble(i) {
    ...
    const _ = 2047 & JSBI.__kBitConversionInts[1] >>> 20, t = _ - 1023, e = (0 | t / 30) + 1, n2 = new JSBI(e, 0 > i);
    let g2 = 1048575 & JSBI.__kBitConversionInts[1] | 1048576, o = JSBI.__kBitConversionInts[0];
    const s = 20, l = t % 30;
    let r, a = 0;
    if (l < 20) {
      const i2 = s - l;
      a = i2 + 32, r = g2 >>> i2, g2 = g2 << 32 - i2 | o >>> i2, o <<= 32 - i2;
    } else if (l === 20)
      a = 32, r = g2, g2 = o, o = 0;
    else {
      const i2 = l - s;
      a = 32 - i2, r = g2 << i2 | o >>> 32 - i2, g2 = o << i2, o = 0;
    }
    n2.__setDigit(e - 1, r);
    for (let _2 = e - 2; 0 <= _2; _2--)
      0 < a ? (a -= 30, r = g2 >>> 2, g2 = g2 << 30 | o >>> 2, o <<= 30) : r = 0, n2.__setDigit(_2, r);
    return n2.__trim();
  }
  ...
  static __fromString(i, _ = 0) {
    ...
    if (_ === 0) {
      if (_ = 10, g2 === 48) {
        if (++n2 === e)
          return JSBI.__zero();
        if (g2 = i.charCodeAt(n2), g2 === 88 || g2 === 120) {
          if (_ = 16, ++n2 === e)
            return null;
          g2 = i.charCodeAt(n2);
        } else if (g2 === 79 || g2 === 111) {
          if (_ = 8, ++n2 === e)
            return null;
          g2 = i.charCodeAt(n2);
        } else if (g2 === 66 || g2 === 98) {
    ...
    if (n2 !== e) {
      if (!JSBI.__isWhitespace(g2))
        return null;
      for (n2++; n2 < e; n2++)
        if (g2 = i.charCodeAt(n2), !JSBI.__isWhitespace(g2))
          return null;
    }
  ...
  static __fillFromParts(_, t, e) {
    ...
    for (let s = t.length - 1; 0 <= s; s--) {
      const i = t[s], l = e[s];
      g2 |= i << o, o += l, o === 30 ? (_.__setDigit(n2++, g2), o = 0, g2 = 0) : 30 < o && (_.__setDigit(n2++, 1073741823 & g2), o -= 30, g2 = i >>> l - o);
    }
    if (g2 !== 0) {
      if (n2 >= _.length)
  ...
  static __toStringBasePowerOfTwo(_, i) {
    ...
    const n2 = e, g2 = i - 1, o = _.__digit(t - 1), s = JSBI.__clz30(o);
    ...
    for (let e2 = 0; e2 < t - 1; e2++) {
      const i2 = _.__digit(e2), t2 = (u | i2 << d) & g2;
      r[a--] = JSBI.__kConversionChars[t2];
      const o2 = n2 - d;
      for (u = i2 >>> o2, d = 30 - o2; d >= n2; )
        r[a--] = JSBI.__kConversionChars[u & g2], u >>>= n2, d -= n2;
    }
    const h = (u | o << d) & g2;
    for (r[a--] = JSBI.__kConversionChars[h], u = o >>> n2 - d; u !== 0; )
      r[a--] = JSBI.__kConversionChars[u & g2], u >>>= n2;
    if (_.sign && (r[a--] = "-"), a != -1)
      throw new Error("implementation bug");
    return r.join("");
  }
  static __toStringGeneric(_, i, t) {
    ...
    const n2 = 30 * e - JSBI.__clz30(_.__digit(e - 1)), g2 = JSBI.__kMaxBitsPerChar[i], o = g2 - 1;
  ...
  static __compareToNumber(i, _) {
    if (JSBI.__isOneDigitInt(_)) {
      ...
      const n2 = Math.abs(_), g2 = i.__unsignedDigit(0);
      return g2 > n2 ? JSBI.__absoluteGreater(t) : g2 < n2 ? JSBI.__absoluteLess(t) : 0;
    }
  ...
  static __compareToDouble(i, _) {
    ...
    if (0 > n2)
      return JSBI.__absoluteGreater(t);
    const g2 = i.length;
    let o = i.__digit(g2 - 1);
    const s = JSBI.__clz30(o), l = 30 * g2 - s, r = n2 + 1;
    if (l < r)
  ...
  static __absoluteAdd(_, t, e) {
    ...
    let n2 = _.length;
    (_.__clzmsd() === 0 || t.length === _.length && t.__clzmsd() === 0) && n2++;
    const g2 = new JSBI(n2, e);
    let o = 0, s = 0;
    for (; s < t.length; s++) {
      const i = _.__digit(s) + t.__digit(s) + o;
      o = i >>> 30, g2.__setDigit(s, 1073741823 & i);
    }
    for (; s < _.length; s++) {
      const i = _.__digit(s) + o;
      o = i >>> 30, g2.__setDigit(s, 1073741823 & i);
    }
    return s < g2.length && g2.__setDigit(s, o), g2.__trim();
  }
  static __absoluteSub(_, t, e) {
    ...
    let g2 = 0, o = 0;
    for (; o < t.length; o++) {
      const i = _.__digit(o) - t.__digit(o) - g2;
      g2 = 1 & i >>> 30, n2.__setDigit(o, 1073741823 & i);
    }
    for (; o < _.length; o++) {
      const i = _.__digit(o) - g2;
      g2 = 1 & i >>> 30, n2.__setDigit(o, 1073741823 & i);
    }
    return n2.__trim();
  }
  static __absoluteAddOne(_, i, t = null) {
    ...
    for (let g2 = 0; g2 < e; g2++) {
      const i2 = _.__digit(g2) + n2;
      n2 = i2 >>> 30, t.__setDigit(g2, 1073741823 & i2);
    }
    return n2 != 0 && t.__setDigitGrow(e, 1), t;
  }
  static __absoluteSubOne(_, t) {
    const e = _.length;
    t = t || e;
    const n2 = new JSBI(t, false);
    let g2 = 1;
    for (let o = 0; o < e; o++) {
      const i = _.__digit(o) - g2;
      g2 = 1 & i >>> 30, n2.__setDigit(o, 1073741823 & i);
    ...
    if (g2 != 0)
      throw new Error("implementation bug");
    for (let g3 = e; g3 < t; g3++)
      n2.__setDigit(g3, 0);
    return n2;
  }
  static __absoluteAnd(_, t, e = null) {
    let n2 = _.length, g2 = t.length, o = g2;
    if (n2 < g2) {
      o = n2;
      const i = _, e2 = n2;
      _ = t, n2 = g2, t = i, g2 = e2;
  ...
  static __absoluteCompare(_, t) {
    ...
    if (e != 0)
      return e;
    let n2 = _.length - 1;
    for (; 0 <= n2 && _.__digit(n2) === t.__digit(n2); )
      n2--;
    return 0 > n2 ? 0 : _.__unsignedDigit(n2) > t.__unsignedDigit(n2) ? 1 : -1;
  }
  static __multiplyAccumulate(_, t, e, n2) {
    if (t === 0)
      return;
    const g2 = 32767 & t, o = t >>> 15;
    let s = 0, l = 0;
    for (let r, a = 0; a < _.length; a++, n2++) {
      r = e.__digit(n2);
      const i = _.__digit(a), t2 = 32767 & i, u = i >>> 15, d = JSBI.__imul(t2, g2), h = JSBI.__imul(t2, o), m2 = JSBI.__imul(u, g2), b = JSBI.__imul(u, o);
      r += l + d + s, s = r >>> 30, r &= 1073741823, r += ((32767 & h) << 15) + ((32767 & m2) << 15), s += r >>> 30, l = b + (h >>> 15) + (m2 >>> 15), e.__setDigit(n2, 1073741823 & r);
    }
    for (; s != 0 || l !== 0; n2++) {
      let i = e.__digit(n2);
  ...
  static __internalMultiplyAdd(_, t, e, g2, o) {
    let s = e, l = 0;
    for (let n2 = 0; n2 < g2; n2++) {
      const i = _.__digit(n2), e2 = JSBI.__imul(32767 & i, t), g3 = JSBI.__imul(i >>> 15, t), a = e2 + ((32767 & g3) << 15) + l + s;
      s = a >>> 30, l = g3 >>> 15, o.__setDigit(n2, 1073741823 & a);
    }
    if (o.length > g2)
      for (o.__setDigit(g2++, s + l); g2 < o.length; )
        o.__setDigit(g2++, 0);
    else if (s + l !== 0)
      throw new Error("implementation bug");
  }
  __inplaceMultiplyAdd(i, _, t) {
    ...
    let g2 = 0, o = _;
    for (let s = 0; s < t; s++) {
      const i2 = this.__digit(s), _2 = 32767 & i2, t2 = i2 >>> 15, l = JSBI.__imul(_2, e), r = JSBI.__imul(_2, n2), a = JSBI.__imul(t2, e), u = JSBI.__imul(t2, n2);
      let d = o + l + g2;
      g2 = d >>> 30, d &= 1073741823, d += ((32767 & r) << 15) + ((32767 & a) << 15), g2 += d >>> 30, o = u + (r >>> 15) + (a >>> 15), this.__setDigit(s, 1073741823 & d);
    }
    if (g2 != 0 || o !== 0)
      throw new Error("implementation bug");
  }
  static __absoluteDivSmall(_, t, e = null) {
    ...
    let n2 = 0;
    for (let g2, o = 2 * _.length - 1; 0 <= o; o -= 2) {
      g2 = (n2 << 15 | _.__halfDigit(o)) >>> 0;
      const i = 0 | g2 / t;
      n2 = 0 | g2 % t, g2 = (n2 << 15 | _.__halfDigit(o - 1)) >>> 0;
      const s = 0 | g2 / t;
      n2 = 0 | g2 % t, e.__setDigit(o >>> 1, i << 15 | s);
    }
    return e;
  }
  static __absoluteModSmall(_, t) {
    ...
    for (let n2 = 2 * _.length - 1; 0 <= n2; n2--) {
      const i = (e << 15 | _.__halfDigit(n2)) >>> 0;
      e = 0 | i % t;
    }
    return e;
  }
  static __absoluteDivLarge(i, _, t, e) {
    const g2 = _.__halfDigitLength(), n2 = _.length, o = i.__halfDigitLength() - g2;
    let s = null;
    t && (s = new JSBI(o + 2 >>> 1, false), s.__initializeDigits());
    const l = new JSBI(g2 + 2 >>> 1, false);
    l.__initializeDigits();
    const r = JSBI.__clz15(_.__halfDigit(g2 - 1));
    0 < r && (_ = JSBI.__specialLeftShift(_, r, 0));
    const a = JSBI.__specialLeftShift(i, r, 1), u = _.__halfDigit(g2 - 1);
    let d = 0;
    for (let r2, h = o; 0 <= h; h--) {
      r2 = 32767;
      const i2 = a.__halfDigit(h + g2);
      if (i2 !== u) {
        const t2 = (i2 << 15 | a.__halfDigit(h + g2 - 1)) >>> 0;
        r2 = 0 | t2 / u;
        let e3 = 0 | t2 % u;
        const n3 = _.__halfDigit(g2 - 2), o2 = a.__halfDigit(h + g2 - 2);
        for (; JSBI.__imul(r2, n3) >>> 0 > (e3 << 16 | o2) >>> 0 && (r2--, e3 += u, !(32767 < e3)); )
          ;
      }
      JSBI.__internalMultiplyAdd(_, r2, 0, n2, l);
      let e2 = a.__inplaceSub(l, h, g2 + 1);
      e2 !== 0 && (e2 = a.__inplaceAdd(_, h, g2), a.__setHalfDigit(h + g2, 32767 & a.__halfDigit(h + g2) + e2), r2--), t && (1 & h ? d = r2 << 15 : s.__setDigit(h >>> 1, d | r2));
    }
    if (e)
  ...
  __inplaceAdd(_, t, e) {
    let n2 = 0;
    for (let g2 = 0; g2 < e; g2++) {
      const i = this.__halfDigit(t + g2) + _.__halfDigit(g2) + n2;
      n2 = i >>> 15, this.__setHalfDigit(t + g2, 32767 & i);
    }
    return n2;
  }
  __inplaceSub(_, t, e) {
    ...
    if (1 & t) {
      t >>= 1;
      let g2 = this.__digit(t), o = 32767 & g2, s = 0;
      for (; s < e - 1 >>> 1; s++) {
        const i2 = _.__digit(s), e2 = (g2 >>> 15) - (32767 & i2) - n2;
        n2 = 1 & e2 >>> 15, this.__setDigit(t + s, (32767 & e2) << 15 | 32767 & o), g2 = this.__digit(t + s + 1), o = (32767 & g2) - (i2 >>> 15) - n2, n2 = 1 & o >>> 15;
      }
      const i = _.__digit(s), l = (g2 >>> 15) - (32767 & i) - n2;
      n2 = 1 & l >>> 15, this.__setDigit(t + s, (32767 & l) << 15 | 32767 & o);
      if (t + s + 1 >= this.length)
        throw new RangeError("out of bounds");
      (1 & e) == 0 && (g2 = this.__digit(t + s + 1), o = (32767 & g2) - (i >>> 15) - n2, n2 = 1 & o >>> 15, this.__setDigit(t + _.length, 1073709056 & g2 | 32767 & o));
    } else {
      t >>= 1;
      let g2 = 0;
      for (; g2 < _.length - 1; g2++) {
        const i2 = this.__digit(t + g2), e2 = _.__digit(g2), o2 = (32767 & i2) - (32767 & e2) - n2;
        n2 = 1 & o2 >>> 15;
        const s2 = (i2 >>> 15) - (e2 >>> 15) - n2;
        n2 = 1 & s2 >>> 15, this.__setDigit(t + g2, (32767 & s2) << 15 | 32767 & o2);
      }
      const i = this.__digit(t + g2), o = _.__digit(g2), s = (32767 & i) - (32767 & o) - n2;
      n2 = 1 & s >>> 15;
      let l = 0;
      (1 & e) == 0 && (l = (i >>> 15) - (o >>> 15) - n2, n2 = 1 & l >>> 15), this.__setDigit(t + g2, (32767 & l) << 15 | 32767 & s);
    }
    return n2;
  }
  __inplaceRightShift(_) {
    ...
    for (let n2 = 0; n2 < e; n2++) {
      ...
      this.__setDigit(n2, 1073741823 & i << 30 - _ | t), t = i >>> _;
    }
    this.__setDigit(e, t);
  }
  static __specialLeftShift(_, t, e) {
    ...
    return 0 < e && n2.__setDigit(g2, o), n2;
  }
  static __leftShiftByAbsolute(_, i) {
    const t = JSBI.__toShiftAmount(i);
    if (0 > t)
      throw new RangeError("BigInt too big");
    const e = 0 | t / 30, n2 = t % 30, g2 = _.length, o = n2 !== 0 && _.__digit(g2 - 1) >>> 30 - n2 != 0, s = g2 + e + (o ? 1 : 0), l = new JSBI(s, _.sign);
    if (n2 === 0) {
      let t2 = 0;
      for (; t2 < e; t2++)
        l.__setDigit(t2, 0);
  ...
  static __rightShiftByAbsolute(_, i) {
    const t = _.length, e = _.sign, n2 = JSBI.__toShiftAmount(i);
    if (0 > n2)
      return JSBI.__rightShiftByMaximum(e);
    const g2 = 0 | n2 / 30, o = n2 % 30;
    let s = t - g2;
    if (0 >= s)
      return JSBI.__rightShiftByMaximum(e);
    let l = false;
    if (e) {
      if ((_.__digit(g2) & (1 << o) - 1) != 0)
        l = true;
      else
        for (let t2 = 0; t2 < g2; t2++)
          if (_.__digit(t2) !== 0) {
    ...
    if (o === 0) {
      r.__setDigit(s - 1, 0);
      for (let e2 = g2; e2 < t; e2++)
        r.__setDigit(e2 - g2, _.__digit(e2));
    } else {
      let e2 = _.__digit(g2) >>> o;
      const n3 = t - g2 - 1;
      for (let t2 = 0; t2 < n3; t2++) {
        const i2 = _.__digit(t2 + g2 + 1);
  ...
  static __truncateToNBits(i, _) {
    const t = 0 | (i + 29) / 30, e = new JSBI(t, _.sign), n2 = t - 1;
  ...
  static __truncateAndSubFromPowerOfTwo(_, t, e) {
    var n2 = Math.min;
    const g2 = 0 | (_ + 29) / 30, o = new JSBI(g2, e);
    let s = 0;
    const l = g2 - 1;
    let a = 0;
  ...
  __setHalfDigit(_, i) {
    const t = _ >>> 1, e = this.__digit(t), n2 = 1 & _ ? 32767 & e | i << 15 : 1073709056 & e | 32767 & i;
    this.__setDigit(t, n2);
  }
